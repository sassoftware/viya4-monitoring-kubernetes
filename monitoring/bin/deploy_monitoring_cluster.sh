...
generateIngressPromOperator "$autogeneratedYAMLFile"
generateStorageClassReference "alertmanager" "$autogeneratedYAMLFile"
generateStorageClassReference "grafana"      "$autogeneratedYAMLFile"
generateStorageClassReference "prometheus"   "$autogeneratedYAMLFile"
