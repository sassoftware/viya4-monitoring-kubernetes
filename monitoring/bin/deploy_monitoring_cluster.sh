...
if [ "$AUTOGENERATE_INGRESS" == "true" ]; then
   ...
   if [ "$MON_TLS_PATH_INGRESS" != "true" ] && [ "$ingressRouting" == "path" ]; then
   ...
   ingressSampleFile="samples/ingress/${ingressRouting}-based-ingress/monitoring/user-values-prom-operator.yaml"
