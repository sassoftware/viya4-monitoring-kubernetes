...
**Note:** Before using this sample, be sure to read [Configure Alertmanager](https://documentation.sas.com/?softwareId=obsrv&softwareVersion=prod&docsetId=obsrvdply&docsetTarget=n0auhd4hutsf7xn169hfvriysz4e.htm#n1f1zksk28wn8wn1q115nbz1tdln ) in the SAS Viya Monitoring for Kubernetes Help Center.
...
[Create the Deployment Directory](https://documentation.sas.com/?softwareId=obsrv&softwareVersion=prod&docsetId=obsrvdply&docsetTarget=p15fe8611w9njkn1fucwbvlz8tyg.htm) for information about the customization process.
...
3. Deploy monitoring using the standard deployment script. See [Deploy](https://documentation.sas.com/?softwareId=obsrv&softwareVersion=prod&docsetId=obsrvdply&docsetTarget=n1rhzwx0mcnnnun17q11v85bspyk.htm).
