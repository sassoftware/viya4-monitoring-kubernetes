...
|--|--|--|--|
| OpenSearch Datasource Plugin (Grafana) | 2.32.4 | https://github.com/grafana/opensearch-datasource/releases |Allows Grafana to surface log messages stored in OpenSearch |
