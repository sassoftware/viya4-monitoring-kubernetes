...
| Metrics | Kube State Metrics | k8s.gcr.io/kube-state-metrics/kube-state-metrics:v2.9.2|
...
| Metrics | Configuration Reloader (Alertmanager, Grafana) | quay.io/prometheus-operator/prometheus-config-reloader:v0.67.1|
