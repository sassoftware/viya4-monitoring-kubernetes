     ...
     if [ "$rc" != "0" ]; then
       ...
       case $USER_NAME in
        ...
        logcollector)
          ...
          log_notice "       kubectl -n logging delete pods -l 'app.kubernetes.io/name=fluent-bit, fbout=es'"
          echo ""
          ;;
        kibanaserver)
          echo ""
        ...
        metricgetter)
          ...
          log_notice "                                                                                      "
          log_notice " This can be done by submitting the following command:                                "
          log_notice "       kubectl -n logging delete pods -l 'app=prometheus-elasticsearch-exporter'      "
          echo ""
          ;;
        *)
        log_error "The user name [$USER_NAME] you provided is not one of the supported internal users; exiting"
