...
if [ "$HELM_VER_MAJOR" == "2" ]; then
    ...
    log_notice "Helm 3 has reached end-of-life and is only receiving security patches."
    log_notice "See: https://helm.sh/blog/helm-v3-end-of-life/ for details"
    log_notice "Please upgrade to Helm 4 as soon as possible"
